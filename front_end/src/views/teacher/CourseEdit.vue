        ...
        <v-col>
          ...
          <v-card max-width="600" class="mx-auto mt-8">
            <v-toolbar color="primary" dark>
              ...
              <v-spacer></v-spacer>
              <v-icon @click="handleCreateTest">mdi-plus</v-icon>
            </v-toolbar>
            <v-list subheader two-line>
              <v-list-item v-for="test in testList" :key="test.id">
                ...
                <v-list-item-content>
                  <v-list-item-title >
                    ...
                    <v-chip
                      ...
                      v-if="test.availability==='NOT_START'"
                      color="#B3E5FC"
                      text-color="#039BE5"
                    >
                      未开始
                ...
                <v-list-item-action>
                  <v-btn icon>
                    <v-icon color="grey lighten-1" @click="handleTestPeek(test.id)"
                      >mdi-more</v-icon
                    >
                  </v-btn>
                </v-list-item-action>
...
export default {
  ...
  methods: {
    ...
    handleCreateTest() {
      const { courseId } = this.$route.params;
      this.$router.push("test/create/" + courseId);
    },
    handleTestPeek(testId) {
      this.$router.push("test/peek/" + testId);
    }
  },
