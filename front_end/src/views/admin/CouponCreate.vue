...
export default {
  ...
  methods: {
    ...
    beforeSubmit() {
      ...
      if (this.couponInfo.scope === "单一课程" && this.meta.courseId === "") {
        this.msg = "课程ID不能为空";
        this.showCompletionDialog = true;
        setTimeout(() => {
          this.showCompletionDialog = false;
