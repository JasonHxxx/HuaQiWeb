...
// question
import QuestionList from "@/views/teacher/Question/QuestionList";
import QuestionCreate from "@/views/teacher/Question/QuestionCreate";
// test
import TestCreate from "@/views/teacher/test/TestCreate";
import TestPeek from "@/views/teacher/test/TestPeek";
import TestDo from "@/views/student/TestDo";
import TestResult from "@/views/student/TestResult";
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "edit/test/create/:courseId",
        name: "TestCreate",
        component: TestCreate
      },
      {
        path: "edit/test/peek/:testId",
        name: "TestPeek",
        component: TestPeek
      },
    ]
  },
  {
    ...
    children: [
      ...
      {
        path: "course/test/result/:testId",
        name: "testResult",
        component: TestResult
      },
      {
        path: "course/test/do/:testId",
        name: "testDo",
        component: TestDo
      }
    ]
